...
public class SaiaFarmerData {
    ...
    public SaiaFarmerData(String head_name, String gender, String son_wife_daughter, String literacy, String village, String farmer_address_coordinates, String address_landmark) {
